...
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Contact/Page/Inline/Email.tpl', 28, false),array('modifier', 'nl2br', 'CRM/Contact/Page/Inline/Email.tpl', 59, false),)), $this); ?>
<div id="crm-email-content" <?php if ($this->_tpl_vars['permission'] == 'edit'): ?> class="crm-inline-edit" data-edit-params='{"cid": "<?php echo $this->_tpl_vars['contactId']; ?>
